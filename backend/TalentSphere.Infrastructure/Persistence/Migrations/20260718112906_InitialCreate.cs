    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HiringDecisionRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HiringDecisionRecords_AspNetUsers_DecidedByUserId",
                        column: x => x.DecidedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HiringDecisionRecords_JobApplications_JobApplicationId",
                        column: x => x.JobApplicationId,
                        principalTable: "JobApplications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HiringDecisionRecords_DecidedByUserId",
                table: "HiringDecisionRecords",
                column: "DecidedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_HiringDecisionRecords_JobApplicationId",
                table: "HiringDecisionRecords",
                column: "JobApplicationId",
                unique: true);
